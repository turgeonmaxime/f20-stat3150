...
## Simple motivating example {.allowframebreaks}
  ...
  - Let's generate uniform variates on $(0,1)$ and take the average of their image by $f$:
...
follow this algorithm:
  ...
  2. Compute the sample mean $\overline{g(X)} = \frac{1}{n}g(X_i)$.
...
```{r}
# There's no dplyr::cumsd...
sigma2_hat <- cummean((exp(-unif_vars) - theta_hat)^2)
